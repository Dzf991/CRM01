...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#createBtn").click(function () {
			...
			$.ajax({
				url:"workbench/clue/getOwners",
				type:"get",
				dataType:"json",
				success:function (resp) {
					$("#create-clueOwner").append("<option></option>")
	...
	function pageList(pageNo,pageSize) {
		...
		$.ajax({
			...
			success:function (resp) {
				$("#clueList").empty();
				$.each(resp.pageList,function (i,clue){
					$("#clueList").append(
							"<tr>"+
							"<td><input type='checkbox' /></td>"+
							"<td><a style='text-decoration: none; cursor: pointer;' onclick='window.location.href=\"workbench/clue/getDetail?id=\""+clue.id+"'>"+clue.fullname+"</a></td>"+
							"<td>"+clue.company+"</td>"+
							"<td>"+clue.phone+"</td>"+
							"<td>"+clue.mphone+"</td>"+
							"<td>"+clue.source+"</td>"+
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-call">
								  <option></option>
								<c:forEach items="${applicationScope.appellations}" var="appellation">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-status">
								  <option></option>
									<c:forEach items="${applicationScope.clueStates}" var="clueState">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-source">
								  <option></option>
									<c:forEach items="${applicationScope.sources}" var="source">
...
<%--						<tr>--%>
<%--							<td><input type="checkbox" /></td>--%>
<%--							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/getDetail?id=0572f26ee3144be28edc0a5a216a0bdd'">李四先生</a></td>--%>
<%--							<td>动力节点</td>--%>
<%--							<td>010-84846003</td>--%>
<%--							<td>12345678901</td>--%>
<%--							<td>广告</td>--%>
